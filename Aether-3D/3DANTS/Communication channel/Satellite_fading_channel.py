...
_m = _il.import_module('3DANTS.communication_channel.satellite_fading_channel')
Satellite_Fading_channel = _m.Satellite_Fading_channel
__all__ = ['Satellite_Fading_channel']
